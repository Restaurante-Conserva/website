        ...
        try {
            ...
            if (exportType === 'sales') {
                ...
                Object.values(productMap).forEach(p => {
                    const row = [
                        p.name, p.volume, String(p.qty), p.total.toFixed(2).replace('.', ',')
                    ].map(v => `"${String(v).replace(/"/g, '""')}"`);
                    csv += row.join(';') + '\n';
                });
    ...
    return (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Histórico de Vendas</h3>
                ...
                <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-[#222] rounded-lg p-4 space-y-4 shadow-lg animate-in slide-in-from-top-2 duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
                        <div className="space-y-1">
                            <label className="text-[10px] font-black text-gray-400 dark:text-[#555] uppercase tracking-[0.1em] ml-1">Data Inicial</label>
                        ...
                        <div className="space-y-1">
                            <label className="text-[10px] font-black text-gray-400 dark:text-[#555] uppercase tracking-[0.1em] ml-1">Data Final</label>
                            <div className="relative group">
                                <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-[#333] group-focus-within:text-emerald-500 transition-colors" size={13} />
                                <input
                                    type="date"
                        ...
                        <div className="flex gap-1.5 h-[34px]">
                            <button onClick={setThisMonth} className="flex-1 text-[9px] font-black uppercase tracking-widest border border-gray-200 dark:border-[#222] bg-gray-50 dark:bg-black text-gray-500 dark:text-[#666] hover:border-emerald-500 hover:text-emerald-600 rounded-md transition-all cursor-pointer">
                                Mês Atual
                            </button>
                            <button onClick={setLastMonth} className="flex-1 text-[9px] font-black uppercase tracking-widest border border-gray-200 dark:border-[#222] bg-gray-50 dark:bg-black text-gray-500 dark:text-[#666] hover:border-emerald-500 hover:text-emerald-600 rounded-md transition-all cursor-pointer">
                                Mês Anterior
                            </button>
                        </div>
                        <button
                            ...
                            className="h-[34px] bg-orange-600 text-white rounded-md text-[10px] font-black uppercase tracking-[0.2em] hover:bg-orange-500 disabled:opacity-40 transition-all flex items-center justify-center gap-2 border-none cursor-pointer shadow-lg shadow-orange-600/10"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4 border-t border-gray-100 dark:border-[#1a1a1a]">
                        <div className="space-y-1">
                            <label className="text-[10px] font-black text-gray-400 dark:text-[#555] uppercase tracking-[0.1em] ml-1">Filtrar Produto no Relatório</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-1">
                            <label className="text-[10px] font-bold text-gray-400 dark:text-[#555] uppercase tracking-widest ml-1">Método de Pagamento</label>
                            <select
                                value={methodFilter}
                        ...
                        <div className="space-y-1">
                            <label className="text-[10px] font-bold text-gray-400 dark:text-[#555] uppercase tracking-widest ml-1">Tipo de Exportação</label>
                            <select
                                value={exportType}
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-[#1a1a1a]">
                        <div className="flex items-center gap-4 text-[10px] text-gray-500 dark:text-[#444] font-bold uppercase tracking-wider">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-40 text-white rounded-md text-[10px] font-bold uppercase tracking-widest transition-all border-none cursor-pointer shadow-lg shadow-emerald-600/10"
                        >
            ...
            <div className="flex gap-2">
                ...
                {hasFilters && (
                    <button
                        ...
                        className="flex items-center gap-1 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest border border-red-200 dark:border-red-900/30 text-red-600 bg-red-50 dark:bg-red-500/5 rounded-md hover:bg-red-100 transition-all cursor-pointer"
                    >
                        <X size={12} /> Limpar
                    </button>
                )}
            ...
            <div className="border border-gray-100 dark:border-[#1a1a1a] rounded-lg overflow-hidden bg-white dark:bg-[#0a0a0a] shadow-sm dark:shadow-none">
                <table className="w-full text-left">
                    <thead className="bg-gray-50 dark:bg-black border-b border-gray-100 dark:border-[#1a1a1a] text-gray-500 dark:text-[#444]">
                        <tr>
                            <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest w-6"></th>
                            <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest min-w-[140px]">Data / Hora</th>
                            <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest min-w-[100px]">ID</th>
                            <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest min-w-[160px]">Cliente</th>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] font-medium text-gray-500 dark:text-[#444] tabular-nums tracking-tighter">
                                                    {saleDate ? saleDate.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit', second: '2-digit' }) : '—'}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                            <span className="text-[10px] font-mono font-bold text-gray-500 dark:text-[#333] truncate max-w-[80px] block">
                                                {saleId.slice(-8).toUpperCase()}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4">
                                            <span className="text-xs font-bold text-gray-700 dark:text-gray-300 truncate max-w-[120px] block">
                                                {sale.customerName || 'Avulso'}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4">
                                            <span className="text-[10px] font-bold text-gray-500 dark:text-[#444] uppercase tracking-tighter">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-wrap gap-1">
                                                {(sale.payments || []).map((pm, idx) => (
                                                    <span key={idx} className="text-[9px] font-black uppercase tracking-widest px-1.5 py-0.5 bg-gray-100 dark:bg-[#1a1a1a] text-gray-500 dark:text-[#555] rounded border border-gray-200 dark:border-[#222]">
                                            ...
                                            <td colSpan={8} className="px-4 py-4">
                                                <div className="ml-4 space-y-3">
                                                    ...
                                                    <table className="w-full">
                                                        <thead>
                                                            <tr className="text-[9px] font-black text-gray-400 dark:text-[#444] border-b border-gray-100 dark:border-[#1a1a1a] uppercase tracking-widest">
                                                        ...
                                                        <tbody>
                                                            {(sale.items || []).map((item, iIdx) => (
                                                                <tr key={iIdx} className="text-xs border-b border-gray-50 dark:border-[#111] last:border-0">
                                                                    ...
                                                                    <td className="py-2 text-right font-black text-gray-900 dark:text-gray-100 tabular-nums">
                                                    ...
                                                    <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-[#1a1a1a]">
                                                        <div className="flex gap-4 text-[10px] font-bold text-gray-500 dark:text-[#444] uppercase tracking-widest">
                                                            {(sale.payments || []).map((pm, idx) => (
