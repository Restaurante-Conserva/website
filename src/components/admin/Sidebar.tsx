...
import {
    ...
    Shield, FileText, LayoutGrid, BarChart3
} from 'lucide-react';
...
const menuItems = [
    ...
    { id: 'reports',   label: 'Relatórios', icon: BarChart3,       sub: 'Análises' },
];
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-start">
                                <span className={`text-sm font-medium ${active ? 'text-orange-700 dark:text-orange-400' : ''}`}>{item.label}</span>
                                <span className={`text-xs font-normal ${active ? 'text-orange-500/70' : 'text-gray-400 dark:text-[#555]'}`}>{item.sub}</span>
                            </div>
                        </button>
                    );
                })}
